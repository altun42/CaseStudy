...
abstract class $LoginDataModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? accessToken, String? expirationDate});
}
...
class _$_LoginDataModel implements _LoginDataModel {
  _$_LoginDataModel({required this.accessToken, required this.expirationDate});
  ...
  @override
  String toString() {
    return 'LoginDataModel(accessToken: $accessToken, expirationDate: $expirationDate)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, accessToken, expirationDate);
...
abstract class _LoginDataModel implements LoginDataModel {
  factory _LoginDataModel(
      ...
      required final String? expirationDate}) = _$_LoginDataModel;
