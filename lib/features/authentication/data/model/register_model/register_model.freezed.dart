...
class _$_RegisterModel implements _RegisterModel {
  ...
  @override
  String toString() {
    return 'RegisterModel(username: $username, email: $email, phoneNumber: $phoneNumber, password: $password)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, username, email, phoneNumber, password);
